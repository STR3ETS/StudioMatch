...
return [
    ...
    'problem' => [
        ...
        'placeholder' => 'Describe what went wrong during your session...',
        'photos_label' => 'Add photos (optional, max. 5)',
        'note' => 'Reporting is possible up to 24 hours after the start time. The payout to the studio is paused and StudioMatch mediates.',
        'submit' => 'Send report',
    ],
